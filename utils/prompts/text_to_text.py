...
criteria and the quality of their answers to the user question. You will be given the 
one user prompt ([[PROMPT]]) and two responses ([[RESPONSE A]] and [[RESPONSE B]]) generated by two models.
